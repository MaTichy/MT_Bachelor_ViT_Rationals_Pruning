...
def vit_loader(args):
    if(args == "simple"):
        ...
        model = simple_ViT(
        image_size = 64, # 32, 64 svhn / 64 tiny ;Image size. If you have rectangular images, make sure your image size is the maximum of the width and height
        ...
        num_classes = 200, #10, 200 Number of classes to classify.
        ...
        lr=6e-5,  #4e-5 -> svhn  # 4e-5 #6e-5 #!!!5e-5!!!  4.365158322401661e-05 /e-06 ideal initial lr !!!3e-5, 6e-6 #lr optimizer warmup: 3e-5, lr simple 4e-5, rationals, step size 1 gamma 0.7, batch size 32 grayScale p=90, collor jitter normalize
        activation = rationals.RationalsModel(), #nn.PReLU(), nn.ReLU(), rationals.RationalsModel(), nn.GELU(), 
        )
